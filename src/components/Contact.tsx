...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (data.success) {
        setSuccessMessage('Vielen Dank! Deine Nachricht wurde erfolgreich gesendet. Wir melden uns in Kürze bei dir!');
        setFormData({
          firstName: '',
          lastName: '',
          email: '',
        ...
        setErrorMessage(data.message || 'Beim Senden ist ein Fehler aufgetreten. Bitte versuche es später erneut.');
      }
    } catch (err) {
      console.error('Form submission error:', err);
      setErrorMessage('Es gab ein Problem beim Senden. Bitte versuche es später erneut oder kontaktiere uns direkt.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto text-lg font-medium">
            Hast du Fragen oder m�chtest direkt starten? Schreib uns eine Nachricht oder ruf uns an. Wir freuen uns auf dich!
          </p>
        </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <div className="text-xl font-bold text-white">Gotmarstrasse 3, 37073 G�ttingen</div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <div className="text-xs font-black text-slate-500 uppercase tracking-widest mb-1">�ffnungszeiten</div>
