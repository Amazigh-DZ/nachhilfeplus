    ...
    <nav className={`fixed top-0 left-0 right-0 z-30 px-4 py-6 transition-all duration-300 ${scrolled ? 'py-4' : 'py-6'}`}>
      <div className={`max-w-7xl mx-auto glass rounded-2xl px-6 py-4 flex justify-between items-center transition-all ${scrolled ? 'shadow-2xl border-white/20' : ''}`}>
        ...
        <div className="hidden md:block">
          <button onClick={() => scrollToSection('booking')} className="bg-white text-black px-6 py-2.5 rounded-xl font-black text-sm hover:bg-primary hover:text-white transition-all glow uppercase tracking-tight">
            JETZT STARTEN
          </button>
        </div>
      ...
      <footer className="py-20 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8 mb-10 text-xs font-black uppercase tracking-widest text-slate-500">
            ...
            <button onClick={() => scrollToSection('about')} className="hover:text-white transition-colors">Über uns</button>
            <button onClick={() => scrollToSection('offers')} className="hover:text-white transition-colors">Angebot</button>
            <button onClick={() => scrollToSection('contact')} className="hover:text-white transition-colors">Kontakt</button>
            <button onClick={() => scrollToSection('impresium')} className="hover:text-white transition-colors">Impresium</button>
            <button onClick={() => scrollToSection('contact')} className="hover:text-white transition-colors">Datenschutz</button>
          </div>
